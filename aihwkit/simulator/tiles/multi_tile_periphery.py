...
class MultiTileWithPeriphery(BaseTile, SimulatorTileWrapper):
    ...
    def get_weights(
        ...
        if alpha is not None:
            ...
            self.plog.append(self.create_log_entry(
                "digital_pe", "vector-element", "get_weights", "O(n)", "medium", 
                vector_length=bias.numel(), times=1
            ))
            return (weight * alpha.item() , bias * alpha if self.analog_bias else bias)
        return weight, bias
    ...
    def program_weights(
        ...
        for weight_tile, t_weights in zip(self.tile.weight_tiles, target_weights):

            if x_values is None:
                x_values = eye(self.tile.get_x_size())
                x_values = x_values.to(self.device)
                target_values = x_values @ t_weights.to(self.device).T

            target_max = target_values.abs().max().item()
            if isinstance(w_init, Tensor):
                weight_tile.set_weights(w_init)
            else:
                #self.tile.set_weights_uniform_random(-w_init, w_init)  # type: ignore
                weight_tile.tile.set_weights(rand_like(t_weights, device=self.device) * w_init)

            lr_save = weight_tile.get_learning_rate()  # type: ignore
            weight_tile.set_learning_rate(learning_rate)  # type: ignore

            for _ in range(max_iter):
                y = weight_tile.forward(x_values)
            ...
            weight_tile.set_learning_rate(lr_save)  # type: ignore
    ...
    def program_weights_from_zero(
        ...
        for weight_tile, t_weights in zip(self.tile.weight_tiles, target_weights):
            ...
            for _ in range(5000):
                x_in = randn(weight_tile.get_x_size(), device=self.device)
                y = weight_tile.forward(x_in)
                error = y
    ...
    def read_weights(
        ...
        tile_weights, tile_bias = [], []
        # Estimate weights for each tile
        for weight_tile in self.tile.weight_tiles:
            ...
            if self.analog_bias:
                ones_column = ones(self.in_size * over_sampling, 1, device=self.device, dtype=dtype)
                x_values_with_bias = cat([x_values, ones_column], axis=1)
            else:
                x_values_with_bias = x_values

            est_weight = lstsq(x_values_with_bias, y_values).solution.T.cpu()
            weight, bias = self._separate_weights(est_weight)
            tile_weights.append(weight), tile_bias.append(bias)

        # Combine weights and biases from all tiles
        weight = stack([tile_weight for tile_weight in tile_weights])
        bias = stack([tile_bias for tile_bias in tile_bias]) if self.analog_bias else None
    ...
    def apply_weight_scaling(
        ...
        if omega is not None and omega > 0:
            ...
            self.plog.append(self.create_log_entry(
                "digital_pe", "abs", "weight_scaling", "O(n)", "low", 
                vector_length=combined_weights.numel(), times=1
            ))

            self.plog.append(self.create_log_entry(
                "digital_pe", "max", "weight_scaling", "O(n)", "medium", 
                vector_length=combined_weights.numel(), times=1
            ))
            ...
            self.plog.append(self.create_log_entry(
                "digital_pe", "aritmetic", "weight_scaling", "O(1)", "medium", times=1
            ))
            ...
            self.plog.append(self.create_log_entry(
                "digital_pe", "vector-element", "weight_scaling", "O(n)", "medium", 
                vector_length=combined_weights.numel(), times=1
            ))
    ...
    def get_scales(self) -> Optional[Tensor]:
        ...
        self.plog.append(self.create_log_entry(
            "digital_pe", "arithmetic", "get_scales", "O(1)", "medium", times=1
        ))
    ...
    def apply_out_scaling(
        ...
        if self.out_scaling_alpha is not None:
            ...
            self.plog.append(self.create_log_entry(
                "digital_pe", "vector-element", "forward", "O(n)", "medium", 
                vector_length=values.shape[-1], times=values.shape[0]
            ))
    ...
    def pre_forward(
        ...
        if self.input_range is not None:
            ...
            self.plog.append(self.create_log_entry(
                "digital_pe", "vector-element", "pre_forward", "O(n)", "medium", 
    ...
    def post_forward(
        ...
        if bound is not None and ctx is not None:
            ...
            self.plog.append(self.create_log_entry(
                "digital_pe", "logical", "post_forward", "O(n)", "medium", 
                vector_length=x_output.numel(), times=1
            ))
        ...
        if self.mapping_scales is not None:
            ...
            if scale is not None:
                ...
                self.plog.append(self.create_log_entry(
                    "digital_pe", "arithmetic", "post_forward", "O(1)", "medium", times=1
                ))
            else:
        ...
        if scale is not None:
            self.plog.append(self.create_log_entry(
                "digital_pe", "vector-element", "post_forward", "O(n)", "medium", 
                vector_length=x_output.numel(), times=1
            ))
    ...
    def pre_backward(self, d_input: Tensor, dim: int, ctx: Any = None) -> Tensor:
        ...
        if self.mapping_scales is not None:
            ...
            self.plog.append(self.create_log_entry(
                "digital_pe", "vector-element", "pre_backward", "O(n)", "medium", 
                vector_length=d_input.numel(), times=1
            ))
        ...
        if self.handle_output_bound and ctx is not None:
            ...
            if zero_grad_msk is not None:
                ...
                self.plog.append(self.create_log_entry(
                    "digital_pe", "logical", "pre_backward", "O(n)", "medium", 
                    vector_length=d_input.numel(), times=1
                ))
    ...
    def post_backward(self, d_output: Tensor, dim: int, ctx: Any = None) -> Tensor:
        ...
        if self.input_range is not None and ctx is not None:
            ...
            self.plog.append(self.create_log_entry(
                "digital_pe", "comparison", "post_backward", "O(n)", "low", 
                vector_length=x_input.numel(), times=2
            ))
            ...
            self.plog.append(self.create_log_entry(
                "digital_pe", "vector-vector", "post_backward", "O(n)", "medium",
                vector_length=grad.numel(), times=2
            ))
            ...
            if ir_params.gradient_relative:
                ...
                self.plog.append(self.create_log_entry(
                    "digital_pe", "arithmetic", "post_backward", "O(1)", "low", times=2
                ))
                self.plog.append(self.create_log_entry(
                    "digital_pe", "conditional", "post_backward", "O(1)", "very_low", times=1
                ))
            ...
            if ir_params.manage_output_clipping and zero_grad_msk is not None:
                ...
                self.plog.append(self.create_log_entry(
                    "digital_pe", "arithmetic", "post_backward", "O(1)", "low", times=6
                ))
                self.plog.append(self.create_log_entry(
                    "digital_pe", "conditional", "post_backward", "O(1)", "very_low", times=1
                ))
            ...
            if ir_params.decay > 0:
                ...
                self.plog.append(self.create_log_entry(
                    "digital_pe", "abs", "post_backward", "O(n)", "low",
                    vector_length=x_input.numel(), times=1
                ))
                self.plog.append(self.create_log_entry(
                    "digital_pe", "mean", "post_backward", "O(n)", "medium",
                    vector_length=x_input.numel(), times=1
                ))
                self.plog.append(self.create_log_entry(
                    "digital_pe", "comparison", "post_backward", "O(n)", "low", 
                ...
                self.plog.append(self.create_log_entry(
                    "digital_pe", "arithmetic", "post_backward", "O(1)", "low", times=3
                ))
                self.plog.append(self.create_log_entry(
                    "digital_pe", "conditional", "post_backward", "O(1)", "very_low", times=1
                ))
            ...
            self.plog.append(self.create_log_entry(
                "digital_pe", "getter_setter", "post_backward", "O(1)", "very_low", times=1
            ))
    ...
    def pre_update(
        ...
        if self.input_range is not None:
            ...
            self.plog.append(self.create_log_entry(
                "digital_pe", "vector-element", "pre_update", "O(n)", "medium", 
                vector_length=x_input.numel(), times=1
            ))
        ...
        if self.mapping_scales is not None:
            ...
            self.plog.append(self.create_log_entry(
                "digital_pe", "arithmetic", "pre_update", "O(1)", "medium", times=1
            ))
    ...
    def set_learning_rate(self, learning_rate: Optional[float]) -> None:
        ...
        if learning_rate is not None:
            ...
            # self.plog.append(self.create_log_entry(
            #     "digital_pe", "getter_setter", "set_learning_rate", "O(1)", "very_low", times=1
            # ))
            # self.plog.append(self.create_log_entry(
            #     "digital_pe", "arithmetic", "set_learning_rate", "O(1)", "very_low", times=1
            # ))
